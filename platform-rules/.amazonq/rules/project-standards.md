# Amazon Q Developer Rules — Project Coding Standards

These rules are automatically loaded by Amazon Q Developer for every interaction in this workspace. They enforce entity design, security, testing, timezone handling, concurrency, storage design, report generation, QA automation, query safety, API design, authentication, logging, and secrets management standards.
