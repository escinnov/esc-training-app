# Gemini Code Assist Style Guide — Project Coding Standards

These rules are loaded by Gemini Code Assist for every interaction in this repository. They enforce entity design, security, testing, timezone handling, concurrency, storage design, report generation, QA automation, query safety, API design, authentication, logging, and secrets management standards.
